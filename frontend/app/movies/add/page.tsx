      ...
      <main className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Fill in the details to add a new movie to the database</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleChange("releaseYear", Number.parseInt(e.target.value))}
                    required
                    disabled={isSubmitting}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={isSubmitting}
                />
                <p className="text-xs text-muted-foreground">Enter a URL to an image for the movie poster</p>
              </div>
